...
var sagscroller_constants={
   ...
   // navpanel: { height: '16px', downarrow: '', opacity: 0.6, title: 'Go to Next Content', background: '' },
...
function sagscroller(options){
	...
	this.setting={mode:'manual', inittype:'stunted', pause:3000, animatespeed:1000, ajaxsource:null, rssdata:null, refreshsecs:0, navpanel:{show:true, cancelauto:false}} //default settings
