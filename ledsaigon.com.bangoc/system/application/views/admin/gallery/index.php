...
<option value="<?php echo base_url()?>AdminCP/galleries/main">- - -Tất cả - - -</option>
<?php 
$url = base_url().'AdminCP/galleries/main';
 foreach($listAlbum as $group)

		{
        	echo "<option value=\"".$url.'/'.$group->id."\"".($group->id == $abId?" selected":"").">|-".$group->vn_name."</option>";
        ...
        <form action="" method="post" id="frmAction" name="frmAction">
            ...
            <table cellpadding="0" cellspacing="0" border="0" id="table_data">
                ...
                <tbody>
                    ...
                    <?php if($objects){
						require_once(APPPATH.'models/admin/gallerygroups_m.php');
						$gallerGroups = new Gallerygroups_m();
                    ...
                    <tr style="text-align:center">
                        ...
                        <td><strong><?php echo $gallerGroups->getName($row->ab_id);?></strong></td>
						...
						echo "<img src='uploads/galleries/a_".$avatar."' alt='' width='100' />";

						elseif($type=='swf'||$type =='SWF')
						echo "<img src='publics/admin/images/icon_flash.jpg' alt='' width='100' />";

						}else{
							if($row->link_video) echo $row->link_video;
							elseif($row->link_video) echo "<img src='publics/admin/images/icon-video.png' alt='' width='100' />";
                        ...
                        <td class="button_action">
                            ...
                            <a href="<?php echo base_url() ?>AdminCP/galleries/detail/<?php echo $row->id ?>" class="edit_item" rel="<?php echo $row->id ?>" title="<?php echo lang('edit')?>"></a>
