                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td class="button_action">
                            ...
                            <a href="<?php echo base_url() ?>AdminCP/adsgroups/detail/<?php echo $row->id ?>" class="edit_item" rel="<?php echo $row->id ?>" title="<?php echo lang('edit')?>"></a>
