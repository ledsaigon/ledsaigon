...
<div class="ui-widget-content ui-corner-all"> 
                    ...
                    <h3 class="ui-widget-header ui-corner-all">
						...
						<div class="function_button">
                            ...
                            <a href="AdminCP/partners/main" class="button_cancel">Calcel</a>
...
<?php }?>
                                    <tr>
                                        ...
                                        <td class="border"><input value="<?php echo $website ?>" type="text" id="website" name="website" class="text"/></td>
                                     ...
                                     <tr>
                                        ...
                                        <img src="uploads/partners/a_<?php echo $avatar?>" alt="" width="100" />
