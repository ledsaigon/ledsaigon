            ...
            <table cellpadding="0" cellspacing="0" border="0" id="table_data">
                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td><?php echo $row->nick_yahoo ?></td>
                        <td><?php echo $row->nick_skype ?></td>
                        <td>
                        ...
                        <td class="button_action">
                            <a href="<?php echo base_url() ?>AdminCP/supports/detail/<?php echo $row->id ?>" class="edit_item" rel="<?php echo $row->id ?>" title="<?php echo lang('edit')?>"></a>
