...
<div class="ui-widget-content ui-corner-all"> 
 ...
 $this->load->view('admin/inc/top_toolbar');
		if($pId > 0){
		echo '<a href="'.base_url().'AdminCP/categories/main" title="Trở về danh mục cha" class="back">Trở về danh mục cha </a>';
		}
?>
                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td class="name_<?php echo $row['id']?>" style="text-align:left;padding:5px;">
                           <a href="<?php echo base_url().'AdminCP/categories/main/'.$row['id']?>" title="Xem chuyên mục con của <?php echo $row['vn_name'] ?>"> <strong><?php echo $row['vn_name'] ?></strong></a>
                        ...
                        <td class="button_action">
                            <a href="<?php echo base_url() ?>AdminCP/categories/detail/<?php echo $row['id'] ?>" class="edit_item" rel="<?php echo $row->id ?>" title="Chi tiết"></a>
