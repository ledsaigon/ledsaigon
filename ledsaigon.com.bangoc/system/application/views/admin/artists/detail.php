...
<input value="<?php echo $position ?>" type="text" id="position" name="position" 
                                        ...
                                        class="text" style="width:100px" /> &nbsp; &nbsp; Hiển thị trạng chủ&nbsp;  <input type="checkbox" name="home" value="1"  <?php if($home==1) echo 'checked';?>/>                                        </td> 
...
<input value="<?php if(isset($properties['meta_title']))echo $properties['meta_title'] ?>" type="text" id="meta_title" name="meta_title" 
...
<input value="<?php if(isset($properties['keyword'])) echo $properties['keyword'] ?>" type="text" id="keyword" name="keyword" 
...
<textarea style="width:99%; height:50px"   id="description" name="description"><?php if(isset($properties['description'])) echo $properties['description'] ?></textarea> 
