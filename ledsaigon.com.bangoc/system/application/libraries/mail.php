<?php
    ...
    Class mail{
    	...
    	var	$smtp_host		= "www.mucinstar.com";		// SMTP Server.  Example: mail.earthlink.net
    	var	$smtp_user		= "info@mucinstar.com";		// SMTP Username
    	var	$smtp_pass		= "a1d2m3in";		// SMTP Password
    	...
    	function getEmailInformation() {
    		return array(
                    ...
                    'crlf'=> $this->crlf,
                    'send_multipart'=>$this->send_multipart,
                    '_smtp_auth'=>$this->_smtp_auth,
                    '_safe_mode'=>$this->_safe_mode,
    	...
    	function sendMail($from,$to,$subject,$message,$cc='',$bcc='') {
           ...
           $mail = simplexml_load_file("file/config/mail.xml");
           $CI =& get_instance();
    		$config=array(
                    'protocol'=> 'smtp',
                    'smtp_host'=> $CI->encrypt->decode($mail->mail_setting_smtp_host),
                    'smtp_port'=> $CI->encrypt->decode($mail->mail_setting_smtp_port),
                    'smtp_user'=> $CI->encrypt->decode($mail->mail_setting_smtp_username),
                    'smtp_pass'=> $CI->encrypt->decode($mail->mail_setting_smtp_password),
                    'wordwrap'=>TRUE,
                    'mailtype'=>'html',
                    'charset'=>'utf-8',
                    'smtp_timeout' => 30
