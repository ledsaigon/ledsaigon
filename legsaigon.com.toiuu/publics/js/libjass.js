            ...
            ASS._fromSRTString = function(rawSRT) {
                ...
                script.sort(function(line1, line2) {
                    ...
                    result.dialogues.push(new Dialogue({
                        ...
                        End: line.end,
                        Layer: "0",
                        Text: line.text.replace("<b>", "{\\b1}").replace("</b>", "{\\b0}").replace("<i>", "{\\i1}").replace("</i>", "{\\i0}").replace("<u>", "{\\u1}").replace("</u>", "{\\u0}").replace(/<font color="#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})">/g, function(/* ujs:unreferenced */ substring, red, green, blue) {
