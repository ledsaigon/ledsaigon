            ...
            <table cellpadding="0" cellspacing="0" border="0" id="table_data">
                ...
                <thead> 
                    ...
                    <tr> 
                      ...
                      <?php if($englishLang) echo '<th>'.lang('en_name').'</th>'?>  
                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td class="button_action">
                            ...
                            <a href="<?php echo base_url() ?>AdminCP/staticpages/detail/<?php echo $row->id ?>" class="edit_item" rel="<?php echo $row->id ?>" title="<?php echo lang('edit')?>"></a>
