...
<textarea style="width:99%;height:102px;" name="vn_sapo" id="vn_sapo" ><?php echo (isset($vn_sapo) && $vn_sapo !='')?$vn_sapo:''; ?></textarea>
...
<td class="border">Mô tả (Tiếng Anh) </td> 

<td  class="border">

<textarea style="width:99%;height:102px;" name="en_sapo" id="en_sapo" ><?php echo (isset($en_sapo) && $en_sapo !='')?$en_sapo:''; ?></textarea>
...
<input value="<?php echo $en_title_site ?>" type="text" id="en_title_site" name="en_title_site"  class="text" />                                        </td> 
...
<input value="<?php echo $vn_keyword ?>" type="text" id="vn_keyword" name="vn_keyword" class="text" />                                        </td> 
                                    ...
                                    <td class="border">Keyword (Tiếng Anh)</td>

                                     <td class="border">

<input value="<?php echo $en_keyword ?>" type="text" id="en_keyword" name="en_keyword"  class="text" />                                        </td> 
...
<?php }?>
                                ...
                                <tr>
                                        ...
                                        <img src="uploads/products/<?php echo $avatar?>" width="100" /><br />
                                    ...
                                    <tr>
                                        ...
                                        <td class="border">Background top</p>

                                     </td>

                                        <td class="border">

                                        <?php if(isset($bg_top) && $bg_top ==true){?>

                                        <img src="uploads/products/<?php echo $bg_top?>" height="100" /><br />

                                        <input type="hidden" name="old_avatar_bg" id="old_avatar_bg" value="<?php echo $bg_top?>" />

                                        <?php }?>

                                            <input type="file"  class="text  validate[required]" id="avatar_bg" name="avatar_bg" value=""/>
